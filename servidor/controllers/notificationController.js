  ...
  static async subscriptionNotification(req, res) {
    try {
      ...
      const mailOptionsSubscription = {
        ...
        to: req.body.email,
        subject: "Suscripción Activa a Ofertas Exclusivas | Hotel Mar Azul",
        html: `
          <div style="font-family: Arial, sans-serif; background-color: #FFFFFF; padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
            <h2 style="color: #00a6f4;">¡Bienvenido a Nuestras Ofertas Exclusivas!</h2>
            <p style="color: #2b7fff;">Estimado cliente,</p>
            <p>Gracias por suscribirse a nuestras ofertas exclusivas. A partir de ahora, recibirá promociones especiales y descuentos únicos directamente en su bandeja de entrada.</p>
            <p style="color: #2b7fff;">¡Nos alegra tenerlo con nosotros!</p>
            <p style="color: #999; font-size: 0.9em;">Hotel Mar Azul</p>
          </div>
        `
      };
