...
export default function Blog() {
  ...
  return (
    <div className="space-y-12">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-bold text-sky-500 mb-4">Blog del Hotel Mar Azul</h1>
        <p className="text-xl text-blue-500 mb-8">
          Mantente actualizado con las últimas noticias y consejos de viaje para Isla de Margarita
        </p>
      </motion.section>
        ...
        >
          {blogPosts.map((post) => (
            ...
            >
              ...
              <div className="p-6">
                <h2 className="text-2xl font-bold text-sky-500 mb-2">{post.titulo}</h2>
      ...
      >
        <h2 className="text-2xl font-bold text-sky-500 mb-4">Suscríbete a Nuestro Newsletter</h2>
        <p className="text-gray-600 mb-4">
          Recibe las últimas noticias, ofertas especiales y consejos de viaje directamente en tu bandeja de entrada.
        </p>
        <form className="flex flex-col md:flex-row gap-4" onSubmit={handleSubscription}>
          <input
            type="email"
      ...
      <BlogModal isOpen={isModalOpen} onClose={handleCloseModal} post={selectedPost} />
    </div>
  );
}
